...
describe('calcBudgetSummary', () => {
  const items = [
    { id: '1', trip_id: 't1', category: 'accommodation' as const, label: 'Hostel', amount_eur: 308, is_actual: false },
    { id: '2', trip_id: 't1', category: 'transport'     as const, label: 'Train',  amount_eur: 180, is_actual: false },
    { id: '3', trip_id: 't1', category: 'food'          as const, label: 'Food',   amount_eur: 100, is_actual: true  },
  ]
