  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-16">
      <div className="rounded-2xl border bg-card p-8 text-center">
        <p className="text-sm font-medium text-destructive mb-3">Unexpected error</p>
        <h1 className="text-2xl font-semibold tracking-tight mb-3">
          We could not load the trip dashboard.
        </h1>
        <p className="text-sm text-muted-foreground mb-6">
          Please retry the request. If the problem continues, check the server logs and
          Supabase status before deploying.
        </p>
